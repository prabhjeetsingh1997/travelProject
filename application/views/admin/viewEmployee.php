...
<div class="page-content">
   ...
   <div class="page-heading">
      <h1>All Employee</h1>
      <div class="options">
      <a href="<?php echo base_url(ADMIN_URL) ?>/addEmployee" class="btn btn-primary" role="button">Add Employee</a>
               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php if(!empty($employees)){
                           ...
                           <td align="center">
                               <div id="detail_<?php echo $employee->userId; ?>" style="display:none; text-align: justify;">
                            ...
                            <div id="otherdetail_<?php echo $employee->userId; ?>" style="display:none; text-align: justify;">
                           ...
                           <button type="button" rel="<?php echo $employee->userId; ?>" class="btn btn-info btn-sm viewEmployeeDetail" data-toggle="tooltip" data-placement="top" title="View Personal Details"><i class="fa fa-eye"></i></button>
                            <button type="button" rel="<?php echo $employee->userId; ?>" class="btn btn-info btn-sm viewDetail" data-toggle="tooltip" data-placement="top" title="View Other Details"><i class="fa fa-eye"></i></button>
                           </td>
                           <td><a href="<?php echo base_url(ADMIN_URL) ?>/editEmployee/<?php echo $employee->userId; ?>" data-toggle="tooltip" data-placement="top" title="Edit Employee"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                           <a href="<?php echo base_url(ADMIN_URL) ?>/deleteEmployee/<?php echo $employee->userId; ?>" data-toggle="tooltip" data-placement="top" title="Delete Employee"><i class="fa fa-trash" aria-hidden="true"></i></a>
                           </td>
                        </tr>
                        <?php }
                        } ?>
