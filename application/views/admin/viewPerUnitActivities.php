...
<div class="page-content">
   <ol class="breadcrumb">
      ...
      <li><a href="#">View Per Unit Activites</a></li>
   </ol>
                     ...
                     <?php if(!empty($activities)){
                           ...
                           <td><?php echo $activity->details; ?></td>
                            <td><?php echo $activity->redemption_point; ?></td>
                             <td><?php echo $activity->perunit_cost; ?></td>
                            <td><?php if($activity->status == 1){ echo "Activated"; }else{ echo "Not Activated"; } ?></td>
                           <td><a href="<?php echo base_url(ADMIN_URL) .'//'.$activity->id; ?>" data-toggle="tooltip" data-placement="top" title="Edit Activities"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |
                           <a class="deleteVendor" href="<?php echo base_url(ADMIN_URL) .'//'.$activity->id; ?>" data-toggle="tooltip" data-placement="top" title="Delete Activities"><i class="fa fa-trash" aria-hidden="true"></i></a>
                           </td>
                        </tr>
                        <?php }
                        } ?>
