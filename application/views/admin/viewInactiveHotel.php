               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php if(!empty($partners_hotel)){
                           ...
                           <td><?php echo $hotel->partner_name; ?></td>
                           <td><?php echo $hotel->partner_contact_no; ?></td>
                           <td align="center">
                           ...
                           <td><a href="<?php echo base_url(ADMIN_URL) .'/editHotel/'.base64_encode(1).'/'.base64_encode($hotel->hotel_id); ?>" data-toggle="tooltip" data-placement="top" title="View Hotel Details"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                           <a class="deleteVendor" href="<?php echo base_url(ADMIN_URL).'/activateHotel/'.base64_encode($hotel->hotel_id); ?>" data-toggle="tooltip" data-placement="top" title="Activate Hotel"><i class="fa fa-check" aria-hidden="true"></i></i></a>
                           </td>
                        </tr>
                        <?php }
                        } ?>
