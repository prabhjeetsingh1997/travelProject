               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php if(!empty($partners_hotel)){
                           ...
                           <a class="deleteVendor" href="<?php echo base_url(ADMIN_URL).'/deactivateHotel/'.base64_encode($hotel->hotel_id); ?>" data-toggle="tooltip" data-placement="top" title="Deactivate Hotel"><i class="fa fa-trash" aria-hidden="true"></i></a>
                           </td>
                        </tr>
                        <?php }
                        } ?>
