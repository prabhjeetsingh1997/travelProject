...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="grid-form" action="<?php echo base_url(ADMIN_URL) ?>/addNewActivites" method="POST" enctype="multipart/form-data">
    <fieldset>
      ...
      <legend>Activites Price</legend>
        <div data-row-span="2">
            <div data-field-span="2">
              ...
              <input type="number" class="form-control" name="adult_price" required="true">
            </div>
        </div>
...
<?php
    if ($this->uri->segment(2) == 'addActivities') { ?>
