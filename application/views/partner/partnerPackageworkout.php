                           ...
                           <div id="collapse1" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <form role="form" method="POST" name="search_data" id="search_data">
                                    ...
                                    <input type="hidden" name="queryid" id="queryid" value="<?php echo $query_id; ?>"/>
                                    ...
                                    <input type="hidden" name="queryType" id="queryType" value="partnerPackage">
                                    <div class="row">
                                        <div class="col-md-12">
...
$(document).ready(function(){
    ...
    $(document).on('click','#searchDataBtn',function(){
        ...
        if($("#queryType").val() == 'partnerPackage')
        {
