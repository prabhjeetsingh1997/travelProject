...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="grid-form" action="<?php echo base_url(PARTNER) ?>/addNewEmployee" method="POST">
      <fieldset>
      ...
      <fieldset>
        ...
        <div data-row-span="2">
          ...
          <!--  <input type="radio" name="is_tl" value="1">Yes</label>-->
          <!--  <label class="radio-inline">       -->
          <!--  <input type="radio" name="is_tl" value="0">No</label>-->
          <!--</div>-->
        </div>
        <div data-row-span="3">
          <div data-field-span="1">
...
<?php
    if ($this->uri->segment(2) == 'addEmployee') { ?>
