...
<div class="page-content">
   ...
   <div class="page-heading">
      ...
      <div class="options">
      <a href="<?php echo base_url(PARTNER) ?>/makeItinerary" class="btn btn-primary" role="button">Add Itinerary</a>
               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php if(!empty($itinerary_details)){
                           ...
                           <td><a href="<?php echo base_url(PARTNER) ?>/editPartnerItinerary/1/<?php echo $val['id']; ?>" data-toggle="tooltip" data-placement="top" title="Edit Itinerary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
