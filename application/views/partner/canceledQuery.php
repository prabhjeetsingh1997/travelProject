...
<div class="page-content">
   <ol class="breadcrumb">
      ...
      <li><a href="#">Cancelled Query</a></li>
   </ol>
   <div class="page-heading">
      <h1>Cancelled Query</h1>
      <div class="options">
               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php if(!empty($inHandQuery)){
                           ...
                           <td><a href="<?php echo base_url(PARTNER) ?>/editQuery/<?php echo $query->id; ?>" data-toggle="tooltip" data-placement="top" title="Edit Query"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <a class="deleteVendor" href="<?php echo base_url(PARTNER) ?>/undoConfirmed/<?php echo $query->id; ?>" data-toggle="tooltip" data-placement="top" title="Undo Query"><i class="fa fa-undo" aria-hidden="true"></i></i></a>
...
<?php
    if ($this->uri->segment(2) == 'canceledQuery') { ?>
