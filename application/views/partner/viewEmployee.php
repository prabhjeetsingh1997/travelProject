...
<div class="page-content" style="margin-top:;">
   ...
   <div class="page-heading">
      <h1>All Employee</h1>
      <div class="options">
      <a href="<?php echo base_url(PARTNER) ?>/addEmployee" class="btn btn-primary" role="button">Add Employee</a>
               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php if(!empty($employees)){
                           ...
                           <td><a href="<?php echo base_url(PARTNER) ?>/editEmployee/<?php echo $employee->id; ?>" data-toggle="tooltip" data-placement="top" title="Edit Employee"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                           <a class="deleteVendor" href="<?php echo base_url(PARTNER) ?>/deleteEmployee/<?php echo $employee->id; ?>" data-toggle="tooltip" data-placement="top" title="Delete Employee"><i class="fa fa-trash" aria-hidden="true"></i></a>
                           </td>
                        </tr>
                        <?php }
                        } ?>
...
<!-- #page-content -->
<?php
    if ($this->uri->segment(2) == 'viewEmployee') { ?>
