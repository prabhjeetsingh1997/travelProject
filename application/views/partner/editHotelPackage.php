							...
							<div class="col-md-12" id="vendoremailbody">
								...
								<table class="table table-bordered" cellspacing="0" width="100%">
											 ...
											 <span id="roomPrice_<?php //echo $i+1; ?>">
											     ...
											     $pArr = array();
			                                        foreach($roomprices as $val)
			                                        {
				                                       ...
				                                       $firstpArr = $val*$markup/100 + $val*$markup/100*18/100 + $val;
				                                       $pArr[] = $firstpArr + $firstpArr*$hotelpackage->price_margin/100;
		                                         	}
		                                         	 echo $pArr[$i];
		                                         	 $total = array_sum($pArr);
									...
									<tr>
										...
										<td style="border: 1px solid #f4f4f4;padding: 8px;"><span><i class="fa fa-inr" aria-hidden="true"></i></span><?php echo $rupeeSymbol; ?> <span id="serviceTax"><?php echo number_format(floor($total*5/100)); ?></span></td>
									</tr>
									<tr style="font-size: 18px;font-weight: 600;">
										<td colspan="7" style="text-align:center;border: 1px solid #f4f4f4;padding: 8px;">Grand Total</td>
										<td style="border: 1px solid #f4f4f4;padding: 8px;"><span><i class="fa fa-inr" aria-hidden="true"></i></span><?php echo $rupeeSymbol; ?> <span id="grandTotal"><?php echo number_format(floor($total*5/100 + $total)); ?></span></td>
									</tr>
							</table>
							</div>
