...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="grid-form" action="<?php echo base_url(PARTNER) ?>/updateEmployee" method="POST">
    <input type="hidden" name="employee_id" value="<?php echo $employee->id; ?>">
      <fieldset>
        ...
        <div data-row-span="4">
          <div data-field-span="2" data-field-error="Please enter a valid email address">
            ...
            <input type="text" name="password" required="true" value="<?php echo base64_decode($employee->emp_pass); ?>">
          </div>
          <div data-field-span="1">
      ...
      <fieldset>
        ...
        <div data-row-span="2">
          ...
          <!--  <input type="radio" name="is_tl" required="true" value="1" <?php //echo $employee->is_tl == 1 ? 'checked' : ''; ?>>Yes</label>-->
          <!--  <label class="radio-inline">       -->
          <!--  <input type="radio" name="is_tl" required="true" value="0" <?php //echo $employee->is_tl == 0 ? 'checked' : ''; ?>>No</label>-->
          <!--</div>-->
        </div>
        <div data-row-span="3">
          <div data-field-span="1">
          ...
          <div data-field-span="1">
            ...
            <select id="emp_type" class="form-control" name="emp_type" required="true">
                <option value="">Select Employee Type</option>
                <option value="1" <?php if($employee->emp_type == 1){echo "selected";} ?>>Sales</option>
                <!--<option value="2" <?php //if($employee->emp_type == 2){echo "selected";} ?>>Accounts</option>-->
                </select>
          </div>
        </div>
      </fieldset>
