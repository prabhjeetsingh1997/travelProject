...
<div class="page-content" style="margin-top:;">
   ...
   <div class="page-heading">
      <h1>Cancelled Hotel Bookings</h1>
      <div class="options">
               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      ?>
                                ...
                                <td><?php echo date('d, F Y h:i a', strtotime($package->cancelled_on)); ?></td>
                                <td><?php if($package->hotel_confirmation == 'Cancelled') {?>
                                      <span class="badge badge-primary" style="width: 67px;">
                                ...
                                <td>
                                    ...
                                    <div id="detail_<?php echo $package->id; ?>" style="display:none; text-align: justify;">
                                        ...
                                        <div><strong>Pax name : </strong><span><?php echo $package->lead_pax_name; ?> </span></div>
                                        <div><strong>Created on : </strong><span><?php echo date('d, F Y h:i a', strtotime($package->created_on)); ?></span></div>
                                        <div><strong>Cancel reason : </strong><span><?php echo $package->cancel_reason; ?> </span></div>
                                    </div>
                                </td>
                                </tr>
  ...
  <div class="modal-dialog" style="width: 500px;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modalHead">Cancellation Details</h4>
      </div>
