...
<div class="page-content" style="margin-top:;">
   ...
   <div class="page-heading">
      ...
      <div class="options">
      <a href="<?php echo base_url(PARTNER) ?>/addHotel" class="btn btn-primary" role="button">Add Hotel</a>
               ...
               <div class="panel-body panel-no-padding">
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php if(!empty($partners_hotel)){
                           ...
                           <td><?php echo $hotel->hotel_mobile_no; ?></td>
                           <td><?php echo $hotel->address_line_1.','.$hotel->address_line_2.','.$hotel->city_name.','.$hotel->state_name.','.$hotel->country_name.','.$hotel->zip; ?></td>
                           ...
                           <td align="center">
                               <div id="detail_<?php echo $hotel->hotel_id; ?>" style="display:none; text-align: justify;">
                                   ...
                                   <div><strong>Contact Number : </strong><span><?php echo $hotel->hotel_mobile_no.", ". $hotel->hotel_alternative_no.", ".$hotel->hotel_landline; ?></span></div>
                            ...
                            <div id="otherdetail_<?php echo $hotel->hotel_id; ?>" style="display:none; text-align: justify;">
                               <h4 align="center" style="margin-top: 0px;">Concered Person Details :</h4>
                             ...
                             <div><strong>Contact Number : </strong><span><?php echo $hotel->person_mobile_no.','.$hotel->person_alternative_no; ?></span></div>
                            </div> 
                           ...
                           <td><a href="<?php echo base_url(PARTNER) .'/editHotel/'.base64_encode(1).'/'.base64_encode($hotel->hotel_id); ?>" data-toggle="tooltip" data-placement="top" title="Hotel Employee"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                           <?php if($roleId == ROLE_ADMIN) {?>
                           <a class="deleteVendor" href="<?php echo base_url(PARTNER) .'/deleteHotel/'.base64_encode($hotel->hotel_id); ?>" data-toggle="tooltip" data-placement="top" title="Delete Hotel"><i class="fa fa-trash" aria-hidden="true"></i></a>
                           <?php }?>
                           </td>
                        </tr>
                        <?php }
...
<?php
    if($this->uri->segment(2) == 'viewHotel') { ?>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/demo/pagejs/partner/viewHotel.js"></script>
<?php
    }
?>
