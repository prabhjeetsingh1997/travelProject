...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="sendToCl" class="modal fade">
	<div class="modal-dialog mail-modal">
	   <form name="tour_mail" id="tour_mail" method="post" action="">
			...
			<input type="hidden" name="tourSub" id="tourSub" value="Travel Quotation" />
...
<script type="text/javascript">
    ...
    function downlaod_pdf(param, action)
    {
	    ...
	    var data = "pdfType=hotel&prices="+prices+'&selRooms='+selc_prices+'&emp_mobile='+emp_mobile+'&emp_email='+emp_email+'&empname='+empname+'&partnerLogo='+partnerLogo+'&pMargin='+priceMargin+'&marginAmt='+priceMarginAmt+'&selMealPlans='+selc_meal_plans+'&selMealPlansVal='+meal_plans_val+'&partnerMarkup='+partnerMarkup+'&spcl_Remark='+spcl_remarks+'&taxesIncl='+taxesIncl;
