               ...
               <div class="tab-pane fade <?php if($tab == 1){ echo "active in";}?>" id="tab_default_1">
                     ...
                     <form id="form_registration" action="<?php echo base_url(HOTEL) ?>/updateHotel" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <fieldset>
                                ...
                                <select class="form-control" data-required="true" name="state_id" id="state_id" required="true">
                                    ...
                                    if(!empty($states)){
                                      foreach($states as $state){
                                        if($state->country_id == $hotel_detail->country_id){ ?>
                                ...
                                <select class="form-control" data-required="true" name="city_id" id="city_id" required="true">
                                    <!--<option value="">--Select--</option>-->
                                     <?php if(!empty($cities)){
                                         ...
                                         if($city->state_id == $hotel_detail->state_id) { ?>
                           ...
                           <div class="form-group">
                              ...
                              <!--</div>-->
                              <div class="col-md-4">
                                  <label>Hotel Landline No. <span style="color: red;">*</span></label>
                                 <input class="form-control" id="hotel_landline"  name="hotel_landline" type="number" required value="<?php echo $hotel_detail->hotel_landline; ?>" placeholder="Hotel Landline (If Any)"/>
                              </div>
                              <div class="col-md-4">
                                  <label>Hotel Mobile No. <span style="color: red;">*</span></label>
                                 <input class="form-control" data-required="true" id="hotel_mobile_no"  name="hotel_mobile_no" type="number" value="<?php echo $hotel_detail->hotel_mobile_no; ?>" placeholder="Hotel Mobile" min="10"/>
                              </div>
                              <div class="col-md-4">
                                  <label>Hotel Alternative No. <span style="color: red;">*</span></label>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-3">
                                 ...
                                 <input class="form-control" data-required="true" id="person_name"  name="person_name" type="text" value="<?php echo $hotel_detail->person_name; ?>" placeholder="Full Name" required />
                              </div>
                              <div class="col-md-3">
                                  <label>Concerned Person Email <span style="color: red;">*</span></label>
                                 <input class="form-control" id="person_email"  name="person_email" type="email" value="<?php echo $hotel_detail->person_email; ?>" placeholder="Email" required/>
                              </div>
                              <div class="col-md-3">
                                  <label>Concerned Person Mobile <span style="color: red;">*</span></label>
                                 <input class="form-control" id="person_mobile_no" required name="person_mobile_no" type="number" value="<?php echo $hotel_detail->person_mobile_no; ?>" placeholder="Person Mobile No"/>
                              </div>
                              <div class="col-md-3">
                                  <label>Concerned Person Alternative No.</label>
                          ...
                          <!--          </div>-->
                          <!--          <div class="col-md-3">-->
                          <!--          <input class="form-control" data-required="true" id="room_amenities_<?php //echo $i; ?>"  name="room_amenities_<?php //echo $i; ?>" type="text" placeholder="Amenities & Facilities" value="<?php //echo $rooms->room_amenities; ?>" required readonly/>-->
                          <!--          </div>-->
                          <!--          <div class="col-md-1">-->
                          ...
                          <!--  <div class="form-group" id="add_rooms"></div>-->
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-8">
                                 <input class="form-control" data-required="true" id="hotel_amenity"  name="hotel_amenity" type="hidden" value="<?php echo $hotel_detail->hotel_amenity;?>" placeholder="Amenity & Facility" readonly/>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                 <textarea class="form-control"  data-required="true" id="hotel_description" placeholder="Enter description about hotel." name="hotel_description" value="" rows="5"><?php echo $hotel_detail->hotel_description;?></textarea>
                              </div>
                           </div>
                ...
                <div class="tab-pane fade <?php if($tab == 2){ echo "active in";}?>" id="tab_default_2">
                    <div class="col-sm-12">
                        <form id="form_registration" action="<?php echo base_url(HOTEL) ?>/updateHotel" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            <fieldset>
                                <input type="hidden" name="type" value="updateHotelroom_Details">
                                <input type="hidden" name="hotel_id" value="<?php echo $hotel_id; ?>">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="hidden" name="no_room_types" id="no_room_types" value="<?php echo $hotel_detail->no_room_types; ?>">
                                ...
                                <?php if(!empty($hotel_rooms)){
                                 ...
                                 foreach ($hotel_rooms as $rooms) { ?>
                                   ...
                                   <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                       <input class="form-control" data-required="true" id="room_description_<?php echo $i; ?>"  name="room_description_<?php echo $i; ?>" type="text" value="<?php echo $rooms->room_description; ?>" placeholder="Room Description"/>
                                    </div>
                                    <div class="col-md-2">
                                       <input type="button" value="Room Amentites" class="btn btn-md btn-warning" onClick="room_model(<?php echo $i; ?>);"/>
                                    </div>
                                    <!--<div class="col-md-3">-->
                                    <input class="form-control" data-required="true" id="room_amenities_<?php echo $i; ?>" name="room_amenities_<?php echo $i; ?>" type="hidden" placeholder="Amenities & Facilities" value="<?php echo $rooms->room_amenities; ?>" required readonly/>
                                    <!--</div>-->
                                    <div class="col-md-1">
                                       <input class="form-control" data-required="true" id="room_units_<?php echo $i; ?>" name="room_units_<?php echo $i; ?>" type="text" placeholder="Units" value="<?php echo $rooms->units; ?>"/>
                                    </div>
                                    <div class="col-md-2">
                                       <input class="form-control" type="file" class="custom-file-input" id="editUploadImg<?php echo $i; ?>" name="room_images_<?php echo $i; ?>" onchange="editUploadImg(<?php echo $i; ?>)" aria-describedby="inputGroupFileAddon01" accept="image/*"/>
                                    </div>
                                    <div class="col-md-3">
                                       <!--<button type="button" rel="<?php //echo $rooms->room_id; ?>" class="btn btn-md btn-warning viewRoomDetail" data-toggle="tooltip" data-placement="top" title="View Hotel Photos">Room Pic</button>-->
                                        <div class="img-wrap">
                                            <span class="close">&times;</span>
                                            <img id="dispImg<?php echo $i; ?>" src="<?php echo base_url(ROOM_PHOTOS).$rooms->room_pics; ?>" data-id="<?php echo $rooms->room_id; ?>" width="250px" height="150px;">
                                        </div>
                                    </div>
                                    <!--<div class="room_images" style="display: none;" id="room_photos_<?php //echo $rooms->room_id; ?>">-->
                                    <!--    <div class="img-wrap">-->
                     ...
                     <form id="form_registration" action="<?php echo base_url(HOTEL) ?>/updateHotel" method="POST" class="form-horizontal">
                        ...
                        <fieldset>
                           <div class="form-group">
                              ...
                              <div class="col-md-12">
                                 <input class="form-control" data-required="true" id="pan_no"  name="pan_no" type="text" value="<?php echo $hotel_bank_details->pan_no; ?>" placeholder="GST NO./" required>
                              </div>
                           </div>
                           <div class="form-group">
                               <div class="col-md-12">
                               ...
                               <div class="col-md-12">
                                 <input class="form-control" data-required="true" id="acount_no"  name="acount_no" type="text" value="<?php echo $hotel_bank_details->acount_no; ?>" required placeholder="Account No."/>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                 <input class="form-control" data-required="true" id="acount_holder_name"  name="acount_holder_name" value="<?php echo $hotel_bank_details->acount_holder_name; ?>" required type="text" placeholder="Account Holder Name"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                 <input class="form-control" data-required="true" id="bank"  name="bank" type="text" value="<?php echo $hotel_bank_details->bank; ?>" required placeholder="Bank"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                 <input class="form-control" data-required="true" id="branch"  name="branch" type="text" value="<?php echo $hotel_bank_details->branch; ?>" required placeholder="Branch"/>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                 <input class="form-control" data-required="true" id="ifsc"  name="ifsc" type="text" value="<?php echo $hotel_bank_details->ifsc; ?>" required placeholder="IFSC"/>
                              </div>
                           </div>
                           <div class="clearfix"></div>
                           <div class="form-group">
                     ...
                     <form id="form_registration" action="<?php echo base_url(HOTEL) ?>/updateHotel" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <fieldset>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 <input class="form-control" type="file" id="inputGroupFilePan_card" name="pan_card" aria-describedby="inputGroupFileAddon01"/>
                              </div>
                              <div class="col-md-6">
                                  ...
                                  <?php if(empty($hotel_documents->pan_card_photo)){ ?>
                                    <span id="paNuploadDescr"><p>Image Should be in jpg/jpeg format.</p><p>Image size should not exceed 2MB.</p></span>    
                                  <?php } ?>
                                  
                                  <img src="<?php echo base_url(HOTEL_DOCUMENTS).$hotel_documents->pan_card_photo; ?>" id="pan_cardImg" style="width:300px; height:150px;">
                              </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 <input class="form-control" type="file" id="inputGroupFileContract" name="contracts[]" aria-describedby="inputGroupFileAddon01" multiple="true" />
                              </div>
                              <div class="col-md-6">
                                   ...
                                   <?php if(empty($hotel_documents->contract)){ ?>
                                       <span id="ContractuploadDescr"><p>File Should be in PDf format.</p><p>File size should not exceed 2MB.</p></span>
                                   <?php } ?>
                                   <?php 
                                   $contracts = json_decode($hotel_documents->contract);
                                        foreach ($contracts as $doc => $val) { ?>
                                        <div class="img-wrap" style="border:1px solid grey;">
                                            <!--<span class="close">&times;</span>-->
                                            <span><h5><?php echo $val; ?></h5></span>
                                        </div>
                                     <?php }
                                      ?>
                              </div>
                     ...
                     <form id="form_registration" action="<?php echo base_url(HOTEL) ?>/updateHotel" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <fieldset>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                  <?php if(empty($hotel_photos->hotel_photos)) { ?>
                                     <span>
                                  ...
                                  <?php } ?>
                                   ...
                                   <?php $photos = json_decode($hotel_photos->hotel_photos ); 
                                    ...
                                    <div class="img-wrap">
                                      <span class="close">&times;</span>
                                      <img src="<?php echo base_url(HOTEL_PHOTOS).$val; ?>" data-id="<?php echo $hotel_photos->id; ?>" width="150px" height="150px;">
                                    </div>
                                    <?php }
                                   ?>
                              </div>
                              <div class="col-md-12">
                                ...
                                <!--            <input type="text" name="image_caption[]" class="form-control" style="margin-top: 10px; width:118px; height: 30px;" placeholder="image Caption" value="<?php //echo $caption[$val]; ?>">-->
                                <!--        </div>-->
                                     <?php //}
                                    ?>
                                <!--</div>-->
                                       ...
                                       <div class="col-md-12">
                                           ...
                                           <div class="col-md-6">
                                               <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" rows="5" name="cppakdescription_<?php echo $j;?>"><?php echo $date_rates_detail[$j-1]->description; ?></textarea>
                                               </div>       
                                           </div>
                                       </div>
                           ...
                           <div class="rate">
                              ...
                              <form role="form" name="hotel_rate_1" id="hotel_rate_1">
                                 ...
                                 <div id="rates_1">
                                    ...
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control fromdate" disabled name="fromdate_1" id="" placeholder="Enter Date" value="<?php //echo date('d F Y');?>"/>
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group">
                                          <label for="search">To:Calender</label>
                                          <input type="text" class="form-control todate" disabled name="todate_1" id="" placeholder="Enter Date" value="<?php //echo date('d F Y');?>"/>
                                       </div>
                                    </div>
                                    <div class="bs-example col-md-12" >
                                 ...
                                 <div class="box-footer">
                                    <button type="button" class="btn btn-md btn-warning" name="" rel="" id="cpPakdescriotion" style="display:none;">Package Desc</button></br>
...
<div id="packagedescrmodal" class="modal fade" role="dialog">
  <div class="modal-dialog" style="">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title" id="modalHead">Add Package Description</h4>
      </div>
