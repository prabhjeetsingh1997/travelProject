        ...
        N = function (k, c) {
            ...
            this.doRailClick = function (d, c, g) {
                ...
                b.locked ||
                    (b.cancelEvent(d),
                    c
                        ? ((c = g ? b.doScrollLeft : b.doScrollTop), (f = g ? (d.pageX - b.railh.offset().left - b.cursorwidth / 2) * b.scrollratio.x : (d.pageY - b.rail.offset().top - b.cursorheight / 2) * b.scrollratio.y), c(f))
                        : ((c = g ? b.doScrollLeftBy : b.doScrollBy), (f = g ? b.scroll.x : b.scroll.y), (d = g ? d.pageX - b.railh.offset().left : d.pageY - b.rail.offset().top), (g = g ? b.view.w : b.view.h), f >= d ? c(g) : c(-g)));
            };
                ...
                if (!b.ispage || (!f.cantouch && !f.isieold && !f.isie9mobile)) {
                    ...
                    if (f.isie9mobile)
                        ...
                        if (f.cantouch || b.istouchcapable || b.opt.touchbehavior || f.hasmstouch) {
                            ...
                            b.ontouchend = function (d) {
                                ...
                                if (
                                    b.rail.drag &&
                                    2 == b.rail.drag.pt &&
                                    (b.scrollmom.doMomentum(), (b.rail.drag = !1), b.hasmoving && ((b.hasmoving = !1), (b.lastmouseup = !0), b.hideCursor(), f.hasmousecapture && document.releaseCapture(), !f.cantouch))
                                )
                                    return b.cancelEvent(d);
                            };
                        ...
                        b.onmousemove = function (d) {
                            if (b.rail.drag && 1 == b.rail.drag.pt) {
                                ...
                                b.synched("mousemove", function () {
                                    b.rail.drag &&
                                        1 == b.rail.drag.pt &&
                                        (b.showCursor(), b.rail.drag.hr ? b.doScrollLeft(Math.round(b.scroll.x * b.scrollratio.x), b.opt.cursordragspeed) : b.doScrollTop(Math.round(b.scroll.y * b.scrollratio.y), b.opt.cursordragspeed));
                                });
                                return b.cancelEvent(d);
                            }
                        };
                        ...
                        b.opt.enablemousewheel &&
                            (b.isiframe || b.bind(f.isie && b.ispage ? document : b.docscroll, "mousewheel", b.onmousewheel), b.bind(b.rail, "mousewheel", b.onmousewheel), b.railh && b.bind(b.railh, "mousewheel", b.onmousewheelhr));
                        !b.ispage &&
                            !f.cantouch &&
            ...
            this.onResize = function (d, c) {
                ...
                b.getScrollTop() > b.page.maxh
                    ...
                    : ((b.scroll.y = Math.round(b.getScrollTop() * (1 / b.scrollratio.y))), (b.scroll.x = Math.round(b.getScrollLeft() * (1 / b.scrollratio.x))), b.cursoractive && b.noticeCursor());
            ...
            this.bind = function (d, c, g, e) {
                ...
                "mousewheel" == c
                    ? "onwheel" in b.win
                        ...
                        : ((d = "undefined" != typeof document.onmousewheel ? "mousewheel" : "DOMMouseScroll"), n(h, d, g, e || !1), "DOMMouseScroll" == d && n(h, "MozMousePixelScroll", g, e || !1))
                    : h.addEventListener
                    ? (f.cantouch &&
                    ...
                    ? ((this.prepareTransition = function (c, e) {
                      ...
                      (this.doScrollPos = function (c, e, g) {
                          ...
                          b.timer = setTimeout(function () {
                              ...
                              0 < l &&
                                  (!b.scrollrunning && b.onscrollstart && b.onscrollstart.call(b, { type: "scrollstart", current: { x: h, y: g }, request: { x: c, y: e }, end: { x: b.newscrollx, y: b.newscrolly }, speed: l }),
                                  f.transitionend
                          ...
                          function e() {
                              ...
                              2 == c
                                  ? ((b.timer = 0),
                                    ...
                                    f != b.newscrollx || d != b.newscrolly ? b.doScrollPos(f, d) : b.onscrollend && b.onscrollend.call(b, { type: "scrollend", current: { x: sx, y: sy }, end: { x: b.newscrollx, y: b.newscrolly } }))
                                  : (b.timer = v(e) || 1);
                          }
